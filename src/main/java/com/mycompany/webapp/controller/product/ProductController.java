...
//	@PostMapping("/add")
//	public String register(@ModelAttribute ProductRegisterNormDto productInfo, @ModelAttribute ProductRegisterMPDto files) throws IllegalStateException, IOException {
//		log.info("productInfo ="+ productInfo);
...
////		log.info("file size: " + productInfo.getImg1().getSize());
//		
//		String resultProduct = productService.addProduct(productInfo, files);
//		
//		log.info("result product = " + resultProduct);
//		
////		String rootPath = request.getSession().getServletContext().getRealPath("/");  
